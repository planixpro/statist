...
<title><?= __('session.title') ?> <?= htmlspecialchars(substr($sessionId, 0, 12)) ?>… — Statist</title>
...
<div class="page">
  ...
  <a href="dashboard.php?site=<?= $siteId ?><?= $isBot ? '&tab=bots' : '' ?>" class="back">
   ← <?= __('session.back') ?>
  </a>
  ...
  <div class="page-title">
    ...
    <?php elseif ($isSuspicious): ?>
      <span class="status-badge status-suspicious">~ Suspicious</span>
  ...
  <div class="bot-banner">
    <div>
      <div class="bot-banner-label">Bot Score</div>
      <div class="bot-banner-score"><?= $botScore ?></div>
    </div>
    <div>
      <div class="bot-banner-label">Reason</div>
  ...
  <div class="suspicious-banner">
    ...
    <span>Suspicious session · score <?= $botScore ?></span>
  </div>
  <?php endif; ?>
  ...
  <div class="info-grid">
    ...
    <div class="info-card">
      ...
      <div class="info-card-value"><?= htmlspecialchars($parsedUA['browser']) ?></div>
    </div>
    <div class="info-card">
      <div class="info-card-label"><?= __('session.os') ?></div>
      <div class="info-card-value"><?= htmlspecialchars($parsedUA['os']) ?></div>
    </div>
    <div class="info-card">
