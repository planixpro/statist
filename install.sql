...
--
-- Хост: localhost
-- Время создания: Апр 10 2026 г., 12:20
...
--
-- Структура таблицы `blocked_networks`
--
...
--
-- Индексы таблицы `blocked_networks`
--
ALTER TABLE `blocked_networks`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_cidr` (`cidr`),
...
--
-- AUTO_INCREMENT для таблицы `blocked_networks`
--
ALTER TABLE `blocked_networks`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;
